...
function super_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel( 'spartans_welcome', array(
		'priority'       => 5,
		'title'          => 'Welcome',
		'description'    => 'This is just for peactice',
	) );
			
	// Create our sections
	
	$wp_customize->add_section( 'spartans_alpha' , array(
		'title'             => __( 'Section', 'spartanrur' ),
		'priority'          => 10,
		'description'       => 'This is description of section',
	) );
	...
	$wp_customize->add_control( 'spartans_vision_control', array(
		'label'      => 'Spartans Vision',
		'description'=> 'This is desc of settings',
		'section'    => 'spartans_alpha',
